...
Sidef::Deparse::Julia - Translate Sidef code to Julia code.
...
The purpose of B<Sidef::Deparse::Julia> is to take the AST of a
given Sidef program and to produce and equivalent Julia program.

Usage example:

    $ sidef -Rjulia script.sf

The generated Julia code will be printed to the standard output.

=head1 METHODS

=head2 deparse()

    my $julia_code = $self->deparse($sidef_ast);

Deparse the AST of a Sidef program into Julia code.
...
package Sidef::Deparse::Julia {
    ...
    sub new {
        ...
        my $local = File::ShareDir::dist_file('Sidef-Deparse-Julia', 'Sidef.jl');
...
Please report any bugs or feature requests to C<bug-sidef-deparse-julia at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Sidef-Deparse-Julia>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=Sidef-Deparse-Julia>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Sidef-Deparse-Julia>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/Sidef-Deparse-Julia>

=item * Search CPAN

L<http://search.cpan.org/dist/Sidef-Deparse-Julia/>
